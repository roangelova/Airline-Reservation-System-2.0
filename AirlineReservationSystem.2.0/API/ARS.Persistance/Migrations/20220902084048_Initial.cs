        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AirlineLogo = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeRating = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsReportedLost = table.Column<bool>(type: "bit", nullable: false),
                    BookingNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Baggages_Bookings_BookingNumber",
                        column: x => x.BookingNumber,
                        principalTable: "Bookings",
                        principalColumn: "BookingNumber",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingNumber = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Passenger_Bookings_BookingNumber",
                        column: x => x.BookingNumber,
                        principalTable: "Bookings",
                        principalColumn: "BookingNumber");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAnOffer = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Flights_Destinations_OriginId",
                        column: x => x.OriginId,
                        principalTable: "Destinations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightsBookings", x => new { x.FlightId, x.BookingId });
                    table.ForeignKey(
                        name: "FK_FlightsBookings_Bookings_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Baggages_BookingNumber",
                table: "Baggages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightsBookings_BookingId",
                table: "FlightsBookings",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_Passenger_BookingNumber",
                table: "Passenger",
                column: "BookingNumber");
